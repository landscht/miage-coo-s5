...
public class Collector<T> {
    ...
    public void take(T c3) throws AlreadyCarryingException {
    	if(this.carriedObject == null) {
    		this.carriedObject = c3;
    	}else{
    		throw new AlreadyCarryingException(c3.toString()+" : Already Carrying this object");
    	}
	}
    ...
    public void giveTo(Collector<? super T> otherCollector) throws AlreadyCarryingException {
    	if(otherCollector.getCarriedObject() != null){
    		throw new AlreadyCarryingException(otherCollector.toString()+" : Already Carrying this object");
    	}
